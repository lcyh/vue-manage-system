      ...
      <div
        ...
        <el-button-group>
          <el-button
            type="plain"
            size="mini"
            @click="selectDate('prevYear')">
            {{ t('el.datepicker.prevYear') }}
          </el-button>
          <el-button
            type="plain"
            size="mini"
            @click="selectDate('nextYear')">
...
export default {
  ...
  methods: {
    ...
    selectDate(type) {
      ...
      console.log('selectDate',{prevMonthDatePrefix:this.prevMonthDatePrefix,nextMonthDatePrefix:this.nextMonthDatePrefix});
      let day = '';
      if (type === 'prev-month') {
  ...
  computed: {
    prevMonthDatePrefix() {
      ...
      console.log('prevMonthDatePrefix',fecha.format(temp, 'yyyy-MM-dd'));
      temp.setDate(0);
    ...
    nextMonthDatePrefix() {
      ...
      console.log('nextMonthDatePrefix',fecha.format(temp, 'yyyy-MM-dd'));
      return fecha.format(temp, 'yyyy-MM-dd');
    },
